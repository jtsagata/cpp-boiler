...
[![Travis build Status](@TRAVIS_URL@.svg?branch=master)](@TRAVIS_URL@/cpp-boilerplate)
...
## Documentation
[![Documentation](https://img.shields.io/badge/Documentation-latest-blue.svg)](@PROJECT_HOME_URL@)
