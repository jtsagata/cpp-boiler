...
[comment]: <> (***      Edit the support/README_in.md!                        **)
[comment]: <> (*****************************************************************)

# 'cpp-boiler' A cpp cmake boilerplate project

[![Travis build Status](https://travis-ci.org/jtsagata/cpp-boiler.svg?branch=master.svg?branch=master)](https://travis-ci.org/jtsagata/cpp-boiler.svg?branch=master/cpp-boilerplate)
...
## Documentation
[![Documentation](https://img.shields.io/badge/Documentation-latest-blue.svg)](https://jtsagata.github.io/cpp-boiler/)
